...
public class TG {
    ...
    private void addPlanets() {
        ...
        // Planeta 1
        planet = new Planet(1, 0.25d, new DoubleVector(200, 200), 100000d);
        ...
        // Planeta 2
        planet = new Planet(2, 0.3d, new DoubleVector(325, 225), 100000d);
        ...
        //this.peerController.addVisualObject(planet);
        // Planeta 6
        planet = new Planet(5, 0.25d, new DoubleVector(700, 400), 100000d);
        planet.setAnimation(new Spin(2d, 30));
        planet.setAnimation(new SpinOverprint(SpinOverprintType.HALO_5, 0.3d, -2.2d, 30));
        this.peerController.addVisualObject(planet);
        // Planeta 7
        planet = new Planet(6, 0.5d, new DoubleVector(1000, 400), 100000d);
        planet.setAnimation(new Spin(-0.2d, 30));
