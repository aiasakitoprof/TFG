...
import tg.fx.Spin;
import tg.fx.SpinOverprint;
import tg.fx.SpinOverprintType;
import tg.generator.AsteroidGenerator;
...
public class TG {
    ...
    private void addPlanets() {
        ...
        // Planeta 1
        planet = new Planet(1, 0.25d, new DoubleVector(200, 200));
        ...
        // Planeta 2
        planet = new Planet(2, 0.3d, new DoubleVector(325, 225));
